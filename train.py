# train.py
# Initialize and train a ESRGAN model for image super resolution.
# Tensorflow 2.4.0
# Windows/MacOS/Linux
# Python 3.7
...
def main():
	...
	# gan.save(f"ESRGAN_{epochs}", h5=True)
	gan.save(f"ESRGAN_{epochs}", h5=False)
	...
	loaded_generator = load_model(
		# "ESRGAN_" + str(epochs) + "_generator.h5",
		"ESRGAN_" + str(epochs) + "_generator",
		custom_objects={
			"RRDBlock": RRDBlock, 
